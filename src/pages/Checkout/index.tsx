            ...
            <form onSubmit={handleSubmit(onAdd)}>
                <section className="flex gap-8 w-10/12 m-auto py-20">
                    ...
                    <section className="basis-2/6 w-full">
                            ...
                            <div className="p-10">
                                ...
                                <div className="pb-[30px]">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => onVoucher()}
                                        className="bg-black text-white font-semibold p-3 w-full center hover:bg-slate-700"
                                    >
                                        Áp dụng
                                    </button>
                                </div>
                      ...
                      <span className="grow flex text-[14px]">
                     <span>{(index = index + 1)}.{" "}</span>
                        <span className="font-bold">{item.name}</span> {" "}
                         <span><div style={{backgroundColor: `${item.color}`}} className="w-[20px] h-[20px]" ></div></span>
                          {" "}
                        ...
                        {formatCurrency(item.price * item.quantity)}
                                ...
                                {Payment == 1 ? (
                                    ...
                                    <button className="bg-black text-white font-semibold p-3 mt-10 w-full hover:bg-slate-700 center">
                                    Hoàn tất Đơn hàng
                                    </button>
                                    </div>
                                    </section>
