...
const DetailPost = (props: Props) => {
    ...
    return (
        <div className="w-10/12 m-auto py-5">
            <nav
                className="lg:relative top-[67px] lg:top-0 left-0 right-0 w-full lg:w-auto h-screen lg:h-full transition-transform duration-200">
            ...
            <div className="content mt-5 grid grid-cols-3 gap-6  ">
                ...
                <div className="col-span-1">
                    <h3 className="text-2xl">Tin tức nổi bật</h3>
