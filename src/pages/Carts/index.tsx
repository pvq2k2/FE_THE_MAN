                  ...
                  <tr key={index++} className="border-t-2">
                    ...
                    <td className=" mr-[300px]">
                      {/* <NumericInput
                        ...
                        value={item.quantity}
                      /> */}
                      <NumericInput mobile className="w-[80px] ml-[10px] mr-[-20px] h-[30px] outline-none !border-none"  type="number" min={0}  onChange={(e ) => changeQuantity({cart: item, e})} value={item.quantity} />
                      {/* <button
