            ...
            {isLogged && currentUser ? (
              <div>
                ...
                {currentUser?.users?.role == 1 ? (
                  <Link to={'/admin'}><div className={styles.item_user}>Trang quản trị</div></Link>
                ) : null}
                  <div className={styles.item_user} onClick={() => handleSignout()}>Đăng xuất</div>
              </div>
            ) : (
              <div>
                <Link to={'/signin'}><div className={styles.item_user}>Đăng nhập</div></Link>
                <Link to={'/signup'}><div className={styles.item_user}>Đăng ký</div></Link>
              </div>
            )}
          </div>
        </div>
