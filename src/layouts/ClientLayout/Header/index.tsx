...
const ClientHeader = (props: Props) => {
  ...
  return (
    <header className="mx-auto px-5 lg:px-20 pt-5 flex justify-between border border-b-gray-300 fixed top-0 left-0 right-0 bg-white z-50">
        ...
        <span className="text-black ease-in-out duration-300">
        ...
        <div className="in-up--sub absolute top-[45px] bg-white shadow-xl z-20 p-3 rounded-lg invisible ease-linear duration-300 w-60 xl:left-[-96px] lg:right-[-96px]  group-hover:visible">
                ...
                <ul>
                  <li className='pl-2'>
                    ...
                    <span className="font-bold">
                      {curentUser?.data.fullname}
                    </span>
                  </li>
                  {curentUser?.data.role == 1 ? (
                    <li className="rounded-lg hover:bg-blue-500 hover:text-white">
                      <Link className="inline-block p-2" to="/admin">
                        <span className="text-black font-semibold">Trang quản trị</span>
                      </Link>
                    </li>
                  ) : null}
                  <li className="cursor-pointer mt-2 rounded-lg hover:bg-blue-500 hover:text-white">
                    <div className="text-black font-semibold inline-block p-2" onClick={() => handleSignout()}>Đăng xuất</div>
                  </li>
                </ul>
              ) : (
                <ul>
                <li className="rounded-lg hover:bg-blue-500 hover:text-white"><Link className="inline-block p-2" to="/signin"><span className="text-black font-semibold">Đăng nhập</span></Link></li>
                <li className="rounded-lg hover:bg-blue-500 hover:text-white"><Link className="inline-block p-2" to="/signup"><span className="text-black font-semibold">Đăng ký</span></Link></li>
              </ul>
              )}
