...
const ClientHeader = (props: Props) => {
  ...
  return (
    <header className="mx-auto px-5 lg:px-20 pt-5 flex justify-between border border-b-gray-300 fixed top-0 left-0 right-0 bg-white z-50">
        ...
        <span className="text-black group-hover:text-[#f26629] ease-in-out duration-300">
        ...
        <div className="in-up--sub absolute top-12 bg-white shadow-xl z-20 p-3 rounded-lg invisible ease-linear duration-300 w-60 xl:left-[-96px] lg:right-[-96px]  group-hover:visible
